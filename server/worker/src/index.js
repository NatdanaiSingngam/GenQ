  ...
  "questions": [
    {
      ...
      "options": ["ก", "ข", "ค", "ง"],
      "correctIndex": 0,
      "explanation": "อธิบายสั้นๆ ว่าเลือกข้อนี้เพราะอะไร อ้างอิงเนื้อหา"
    },
    {
      "type": "true-false",
      "question": "ข้อความนี้...",
      "options": ["ถูก", "ผิด"],
      "correctIndex": 0,
      "explanation": "อธิบายสั้นๆ ว่าข้อความนี้ถูกหรือผิดเพราะอะไร"
    },
    {
      "type": "completion",
      ...
      "explanation": "อธิบายสั้นๆ ว่าทำไมถึงเติมคำนี้"
    },
    {
      "type": "matching",
      "question": "จับคู่...",
      "pairs": [{"left": "ซ้าย1", "right": "ขวา1"}, {"left": "ซ้าย2", "right": "ขวา2"}],
      "explanation": "อธิบายหลักการจับคู่ที่ถูกต้อง"
    },
    {
      "type": "short-answer",
      "question": "คำถามสั้น?",
      ...
      "explanation": "อธิบายสั้นๆ ว่าทำไมถึงตอบแบบนี้"
    },
    {
      "type": "essay",
      "question": "อธิบาย...",
      "guidelines": ["ประเด็นที่ควรมี", "แนวคิดสำคัญ"],
      "explanation": "แนวคำตอบที่ถูกต้อง + ประเด็นสำคัญที่ควรมีในคำตอบ"
    }
  ]
}

📌 ข้อกำหนดที่ต้องทำทุกข้อ:
1. คำถามต้องอิงจากเนื้อหาที่ให้ด้านล่างเท่านั้น — ห้ามสร้างคำถามมั่ว
2. คำอธิบาย (explanation) ต้องสั้นแต่ชัดเจน: บอกเหตุผลที่ถูก และถ้าตัวเลือกอื่นผิดเพราะอะไร (อ้างอิงเนื้อหาจริง)
3. ห้ามซ้ำคำถามในชุดเดียวกัน
4. ข้อ true-false ต้องมี options: ["ถูก", "ผิด"]
5. ข้อ completion ต้องมี ___ อย่างน้อย 1 ที่ในคำถาม
6. ข้อ matching ต้องมีอย่างน้อย 3 คู่ซ้าย-ขวา
